...
describe("Lace Torregosa Arellano HR Role & Permissions Verification", () => {
  ...
  test("Lace session has HR status and access", () => {
    ...
    const isRolesManageAllowed = isAdmin && laceSession.approved === true;
    ...
    assert.equal(isRolesManageAllowed, false, "Roles management must be inaccessible to Lace as HR");
