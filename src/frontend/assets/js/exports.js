...
function _wireButtons() {
  ...
  const _switchTab = (type) => {
    ...
    // Gender + year filters — beneficiaries only
...
function _print() {
  ...
  const logoPath = new URL("../../assets/img/logos/c_spes.png", import.meta.url).href;
  ...
  styleEl.textContent = `@media print { @page { size: ${_cfg.orientation}; margin: ${margin}; } }`;
